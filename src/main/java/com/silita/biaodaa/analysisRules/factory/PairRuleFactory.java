        ...
        if(pairRuleList==null) {
            synchronized (lock) {
                if(pairRuleList==null) {
                    ...
                    pairRules.add(new PairRule("(第1名|第2名|第3名|第一|第二|第三|投标企业|公司名称|中标候选人名称|中标单位|中标人名称|中标候选人名称|投标人|中标人|单位名称|候选人|供应商|竞标单位|中标候选人|投标单位|投标单位)", "[\\s\\S\\W\\w.]*((部|中心|合作社|队|所|局|站|院|厂|处|苗圃|城|部|店|公司|事务所)[\\s\\S\\W\\w.]*$)"
                            , FD_ONE_NAME));
                    ...
                    pairRules.add(new PairRule("(项目经理|项目总监|负责人|建造师|姓名)", "([\\u4e00-\\u9fa5]{2,5})", FD_PROJECT_MANAGER));
